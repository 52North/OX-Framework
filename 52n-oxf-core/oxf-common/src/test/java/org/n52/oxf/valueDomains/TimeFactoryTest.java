...
//    private static final Logger LOGGER = LoggerFactory.getLogger(TimeFactoryTest.class);
    ...
    public void
        ...
        final ITime oxfBeforeSwitch = TimeFactory.createTime(beforeSwitch);
        final ITime oxfAtSwitch = TimeFactory.createTime(atSwitch);
        final ITime oxfAfterSwitch = TimeFactory.createTime(afterSwitch);
