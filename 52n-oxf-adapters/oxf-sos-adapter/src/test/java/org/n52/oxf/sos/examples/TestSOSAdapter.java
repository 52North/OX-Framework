...
public class TestSOSAdapter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TestSOSAdapter.class);
     ...
     private final String url = "http://localhost:80/52n-sos-webapp/service";

    // private final String url = "http://sensorweb.demo.52north.org/PegelOnlineSOSv2/sos";

    private final String serviceVersion = "2.0.0";

    public static void main(final String[] args) throws OXFException, ExceptionReport, IOException, URISyntaxException {
...
//                new TestSOSAdapter().testRegisterSensor();
        ...
        new TestSOSAdapter().testInsertSensor();
    }
     ...
     * paramCon.addParameterShell(SOSRequestBuilder_000.VERSION, SOSAdapter.SUPPORTED_VERSIONS[0]);
...
//         "bruehlstrasse"
    ...
    public void testInsertObservation() throws OXFException, ExceptionReport {
        ...
        paramCon.addParameterShell(ISOSRequestBuilder.SERVICE, "SOS");
        paramCon.addParameterShell(ISOSRequestBuilder.VERSION, serviceVersion);
    ...
    public void testInsertCategoryObservation() throws OXFException, ExceptionReport {
        ...
        paramCon.addParameterShell(ISOSRequestBuilder.VERSION,"1.0.0");
        paramCon.addParameterShell(ISOSRequestBuilder.SERVICE,"SOS");
    ...
    public void testRegisterSensor() throws OXFException, ExceptionReport {
        ...
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_OBSERVED_PROPERTY_PARAMETER, "waterlevel");
    ...
    public void testInsertSensor() throws OXFException, ExceptionReport, IOException, URISyntaxException {
        ...
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_PROCEDURE_DESCRIPTION_FORMAT_PARAMETER,
                "http://www.opengis.net/sensorML/1.0.1");
        String xmlString = new String(Files.readAllBytes(Paths.get(new URI(getClass().getResource("/sos_sensor-desc_sample.xml").getPath()).getPath())));
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_ML_DOC_PARAMETER, xmlString);
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_POSITION_FIXED_PARAMETER, "true");
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_POSITION_NAME_PARAMETER, "TestArea_5200_0797");
        paramCon.addParameterShell(ISOSRequestBuilder.REGISTER_SENSOR_UOM_PARAMETER, "mm");
