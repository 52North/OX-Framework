...
public class DescribeSensorParamterBuilder_v100 {
	...
	public static final String OUTPUT_FORMAT_SENSORML = "text/xml;subtype=\"sensorML/1.0.1\""; // defined output format for sensorml
	...
	public DescribeSensorParamterBuilder_v100(String sensorId, String outputFormat) throws IllegalArgumentException {
		...
		parameters.put(ISOSRequestBuilder.DESCRIBE_SENSOR_PROCEDURE_PARAMETER, sensorId);
